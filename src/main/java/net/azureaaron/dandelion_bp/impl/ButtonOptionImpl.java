...
import net.azureaaron.dandelion_bp.api.OptionBinding;
import net.azureaaron.dandelion_bp.api.OptionFlag;
import net.azureaaron.dandelion_bp.api.OptionListener;
import net.azureaaron.dandelion_bp.api.controllers.Controller;
...
public class ButtonOptionImpl implements ButtonOption {
	...
	public static class ButtonOptionBuilderImpl implements ButtonOption.Builder {
		...
		@Override
		public net.azureaaron.dandelion_bp.api.ButtonOption.Builder id(Identifier id) {
			this.id = id;
			return this;
		}

		@Override
		public net.azureaaron.dandelion_bp.api.ButtonOption.Builder name(Component name) {
			this.name = name;
			return this;
		}

		@Override
		public net.azureaaron.dandelion_bp.api.ButtonOption.Builder description(Component... texts) {
			this.description = List.of(texts);
			return this;
		}

		@Override
		public net.azureaaron.dandelion_bp.api.ButtonOption.Builder tags(Component... tags) {
			this.tags = List.of(tags);
			return this;
		}

		@Override
		public net.azureaaron.dandelion_bp.api.ButtonOption.Builder prompt(Component prompt) {
			this.prompt = prompt;
			return this;
		}

		@Override
		public net.azureaaron.dandelion_bp.api.ButtonOption.Builder action(Consumer<Screen> action) {
			this.action = action;
			return this;
		}
