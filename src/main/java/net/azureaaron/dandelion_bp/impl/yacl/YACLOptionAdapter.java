package net.azureaaron.dandelion_bp.impl.yacl;
...
import net.azureaaron.dandelion_bp.api.OptionListener;

public class YACLOptionAdapter {

	protected static List<dev.isxander.yacl3.api.Option<?>> toYaclOptions(List<? extends net.azureaaron.dandelion_bp.api.Option<?>> options) {
	...
	private static <T> dev.isxander.yacl3.api.Option<T> toYaclOption(net.azureaaron.dandelion_bp.api.Option<T> option) {
		return switch (option) {
			case net.azureaaron.dandelion_bp.api.ButtonOption button -> {
			...
			case net.azureaaron.dandelion_bp.api.LabelOption label -> {
				yield (dev.isxander.yacl3.api.Option<T>) dev.isxander.yacl3.api.LabelOption.createBuilder()
				.line(label.label())
				.build();
			}

			case net.azureaaron.dandelion_bp.api.Option<T> _option -> {
	...
	protected static <T> List<OptionEventListener<T>> toYaclOptionEventListener(net.azureaaron.dandelion_bp.api.Option<T> option) {
	...
	protected static List<dev.isxander.yacl3.api.OptionFlag> toYaclOptionFlags(net.azureaaron.dandelion_bp.api.Option<?> option) {
