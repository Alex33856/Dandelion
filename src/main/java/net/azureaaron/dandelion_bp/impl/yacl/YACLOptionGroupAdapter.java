...
public class YACLOptionGroupAdapter {
	...
	protected static List<dev.isxander.yacl3.api.OptionGroup> toYaclOptionGroups(List<net.azureaaron.dandelion_bp.api.OptionGroup> groups) {
	...
	private static dev.isxander.yacl3.api.OptionGroup toYaclOptionGroup(net.azureaaron.dandelion_bp.api.OptionGroup group) {
		return switch (group) {
